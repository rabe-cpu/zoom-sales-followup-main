...
2. Conversation Opening
   - 冒頭に、お客様と実際に話した内容を1〜2文で入れる。
   - 顧客背景、判断軸、営業が受け止めた自然な一文を入れる。
   - `とても印象的でした`、`本気で考えていらっしゃるのが伝わってきました` のような営業所感を重ねない。必要な場合も1文で止める。
...
- 成果保証をしない。
- `伝わってまいりました`、`伝わってきました`、`とても印象的でした` を多用しない。営業所感より、顧客が読み返す判断材料を優先する。
- 営業発話にない余白表現を足さない。
- 金額を漢数字で書かない。
...
- 冒頭に商談で実際に話した内容が1〜2文入っている。
- 1段落が長すぎず、判断軸・作業内容・次アクションが読みやすく分かれている。
